    ...
    fetch("http://localhost:57927/api/Upload/" + sessionStorage.getItem("id"), {
      ...
      .then((folders) => {
        ...
        folders.forEach((folder) => {
          ...
          con += "<br/><p style='color:black;font-size:1.5rem;'><b>";
          ...
          con2 += `<i class='bx bx-star' onclick='fav1(${folder.id})' style="cursor:pointer;margin-left:5%;color:navy;font-size:150%"></i>&nbsp;`;
...
function deletefolder(folderid) {
  ...
  let deleteurl = "http://localhost:57927/api/Upload/folder/put/" + folderid;
...
function fav1(folder) {
  ...
  let url = "http://localhost:57927/api/Upload/favfol/" + folder;
