...
function listTrash() {
  try {
    ...
    create.innerHTML = "";
    fetch(
      "http://localhost:57927/api/trash/" + sessionStorage.getItem("folderid"),
      {
        method: "GET",
      }
    )
      ...
      .then((folders) => {
        ...
        folders.forEach((folder) => {
          ...
          let con2 = "";
          con2 += `<i class='bx bx-revision bx-tada bx-flip-horizontal'  onclick='update(${folder.docid})' style="cursor:pointer;margin-left:10%;color:green;font-size:150%"></i>`;
